// from https://github.com/marekjedlinski/webext-copy-title-url

// Take text selection and clean it up
...
document.addEventListener('keydown', event => {
    modKeyDown = (event.shiftKey || event.ctrlKey); // keyboard shortcut?
});
